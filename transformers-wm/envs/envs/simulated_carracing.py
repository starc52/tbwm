...
class SimulatedCarracing(gym.Env): # pylint: disable=too-many-instance-attributes
    ...
    def __init__(self, directory):
        ...
        transformers_de_state_dict = {k.strip('_l0'): v for k, v in transformers_de_state['state_dict'].items()}
    ...
    def step(self, action):
        ...
        with torch.no_grad():
            ...
            mu, sigma, pi, r, d, _ = self._transformers_de(action, self._lstate.unsqueeze(1))
            pi = pi.squeeze()
