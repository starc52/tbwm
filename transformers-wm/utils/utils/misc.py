...
class RolloutGenerator(object):
    ...
    """
    def __init__(self, mdir, device, time_limit, latents_buffer_size=LBUFFER_SIZE):
        ...
        self.transformers_de.load_state_dict(
            {k.strip('_l0'): v for k, v in transformers_de_state['state_dict'].items()})
    ...
    def get_action_and_transition(self, obs, hidden):
        ...
        _, _, _, _, _, next_hidden = self.transformers_de(action, self.prev_latents_buffer.unsqueeze(1)) # update the understanding given the view
