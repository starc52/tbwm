...
class EncoderSmall(nn.Module): # pylint: disable=too-many-instance-attributes
    """ VAE encoder """
    def __init__(self, img_channels, latent_size):
...
class VAESmall(nn.Module):
    ...
    def __init__(self, img_channels, latent_size):
        ...
        self.encoder = EncoderSmall(img_channels, latent_size)
        self.decoder = DecoderSmall(img_channels, latent_size)
